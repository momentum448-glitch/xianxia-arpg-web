...
const HEALER_WATER_BRIDGE_TEX = 'qc-healer-water-bridge-a4-rgba';
const HEALER_WATER_BRIDGE_PATH = 'assets/c4/environment/settlement/env_healer_water_bridge_a_rgba.png';
